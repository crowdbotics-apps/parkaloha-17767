"""parkaloha_17767 URL Configuration
...
admin.site.site_header = "Parkaloha"
admin.site.site_title = "Parkaloha Admin Portal"
admin.site.index_title = "Parkaloha Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Parkaloha API",
        default_version="v1",
        description="API documentation for Parkaloha App",
    ),
    public=True,
